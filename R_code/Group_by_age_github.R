...
omnibus_model <- lmer(nT2w ~ age_grandmc * dprime_any_NB_median * roi + meanFD_grandmc 
...
# Follow-up for each basal ganglia subregion (roi)
############################################################################################################
Put_model <- lmer(Put ~ meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                  + (1 + age_grandmc || Subj),
                  data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(Put_model)
############################################################################################################
Nac_model <- lmer(Nac ~ meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                  + (1 + age_grandmc || Subj),
                  data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(Nac_model)
############################################################################################################
Caud_model <- lmer(Caud ~ meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                  + (1 + age_grandmc || Subj),
                  data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(Caud_model)
############################################################################################################
GP_model <- lmer(GP ~ meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                   + (1 + age_grandmc || Subj), 
                   data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(GP_model)
...
############################################################################################################
Put_model <- lmer(Put ~ income + meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                  + (1 + age_grandmc || Subj),
                  data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(Put_model)
############################################################################################################
Nac_model <- lmer(Nac ~ income + meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                  + (1 + age_grandmc || Subj), 
                  data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(Nac_model)
############################################################################################################
Caud_model <- lmer(Caud ~ income + meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                   + (1 + age_grandmc || Subj), 
                   data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(Caud_model)
############################################################################################################
GP_model <- lmer(GP ~ income + meanFD_grandmc + dprime_any_NB_median * age_grandmc 
                 + (1 + age_grandmc || Subj),
                 data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(GP_model)
############################################################################################################
...
II_model <- lmer(Put ~ meanFD_grandmc + age_grandmc 
              + (1 + age_grandmc || Subj),
...
ID_model <- lmer(Put ~ meanFD_grandmc + age_grandmc 
                 + (1 + age_grandmc || Subj), 
...
# plot
############################################################################################################
Boost_age_model <- lmer(Put ~ meanFD_grandmc + age * dprime_any_NB_median 
                    + (1 + age_grandmc || Subj),
              data=data, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
############################################################################################################
#no data points
...
############################################################################################################
anyboost_model <- lmer(BG ~ meanFD_grandmc + age_grandmc * AnyBoost_BG 
                       + (1 + age_grandmc || Subj), 
...
############################################################################################################
BB_model <- lmer(BG ~ meanFD_grandmc + age_grandmc * BB_BG 
                 + (1 + age_grandmc || Subj),
                       data=data_planets, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(BB_model)
############################################################################################################
...
############################################################################################################
SB_model <- lmer(BG ~ meanFD_grandmc + age_grandmc * SB_BG
                 + (1 + age_grandmc || Subj), 
                 data=data_planets, control=lmerControl(optimizer="bobyqa",optCtrl=list(maxfun= 2e5)))
summary(SB_model)
